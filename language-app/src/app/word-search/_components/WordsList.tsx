                ...
                >
                  ...
                  >
                    <div className="grid grid-cols-10 auto-rows-auto">
                      ...
                      <span
                        className={cn(
                          "col-span-3 flex max-h-[30px] max-w-[150px] min-w-[100px] text-center items-center justify-self-end text-sm px-2 py-1 rounded-md font-semibold border border-gray-200 ",
